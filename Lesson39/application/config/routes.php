...
$route['complete'] = 'welcome/complete';
...
$route['historys'] = 'welcome/historys';
$route['history/(:any)'] = 'welcome/history/$1';

$route['api/addToCart'] = 'api/addToCart';
$route['api/removeFromCart'] = 'api/removeFromCart';
$route['api/resetTheCart'] = 'api/resetTheCart';
...
$route['console/qa'] = 'console/qa_list';
$route['console/qa/insert'] = 'console/qa_insert';
$route['console/qa/update/(:any)'] = 'console/qa_update/$1';
...
$route['api_console/delete_qa'] = 'api_console/delete_qa';
