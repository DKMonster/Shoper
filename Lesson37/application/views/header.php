<div class="t-header">
	...
	<div class="t-menu">
		<ul>
			<li class="item itemNavSideBar">
				<a href="javascript: void(0)"><i class="icon content"></i></a>
			</li>
			...
			<li class="item <?php if($menu == 'member') { echo 'active'; } ?>">
				<a href="member">會員資訊</a>
			</li>
			<li class="item <?php if($menu == 'member') { echo 'active'; } ?>">
				<a href="member">會員訂單</a>
			</li>
			<li class="item <?php if($menu == 'logout') { echo 'active'; } ?>">
				<a href="logout">登出</a>
			</li>
			<?php }else{ ?>
			<li class="item <?php if($menu == 'login') { echo 'active'; } ?>">
				<a href="login">登入會員</a>
			</li>
			<?php } ?>
...
<div class="ui left sidebar inverted vertical menu sidebarNav">
	<li class="item <?php if($menu == 'store') { echo 'active'; } ?>">
		<a href="/">首頁</a>
	</li>
	<li class="item <?php if($menu == 'news') { echo 'active'; } ?>">
...
<script>
	$(document).ready(function() {
		$('.itemCart').on('click', function(e) {	
			e.preventDefault();
			$('.ui.sidebar.sidebarCart').sidebar('toggle');
		});
		$('.itemNavSideBar').on('click', function(e) {	
			e.preventDefault();
			$('.ui.sidebar.sidebarNav').sidebar('toggle');
		});
